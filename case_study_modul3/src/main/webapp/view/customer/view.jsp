...
<div class="container d-flex ">
    <form action="/customer?action=view" style="width: 70%;margin-left: 155px">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="id" readonly value="${customer.customerId}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Customer Code</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" name="code" readonly value="${customer.customerCode}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Customer Name</label>
            <div class="col-sm-6">
                <input type="text" readonly class="form-control" name="name" value="${customer.customerName}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">customer Birthday</label>
            <div class="col-sm-6">
                <input type="text" readonly class="form-control" name="birthday" value="${customer.customerBirthday}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">customer Gender</label>
            <div class="col-sm-6">
                <input type="text" readonly class="form-control" name="gender" value="
...
<%--                <input type="text" readonly class="form-control" value="<c:choose>--%>
...
<%--                    </c:choose>">--%>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" readonly class="form-control" name="idcard" value="${customer.customerIdCard}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">customer Phone</label>
            <div class="col-sm-6">
                <input type="email" readonly class="form-control" name="phone" value="${customer.customerPhone}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">customer Email</label>
            <div class="col-sm-6">
                <input type="text" readonly class="form-control" name="email" value="${customer.customerEmail}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">customer Address</label>
            <div class="col-sm-6">
                <input type="text" readonly class="form-control" name="address" value="${customer.customerAddress}">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" readonly class="form-control" name="customerTypeId"
